...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "mrtanis" => "mrtanis@appledemacbook-pro.local" }
  # Or just: spec.author    = "mrtanis"
  # spec.authors            = { "mrtanis" => "mrtanis@appledemacbook-pro.local" }
  # spec.social_media_url   = "https://twitter.com/mrtanis"
  ...
  spec.source       = { :git => "git@github.com:mrtanis/KnobControl.git", :tag => "1.0.0" }
